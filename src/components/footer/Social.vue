...
<template>
    <div class="social" :style="{'font-size': size + 'em'}">
        <!-- github -->
        <a :style="{color: color}" :href="social['github'] || 'https://github.com/xianglong123'" target="_blank"><a-icon type="github" /></a>
        <!-- 微信 -->
...
<!--        </a-popover>-->
        <!-- twitter -->
        <a :style="{color: color}" :href="social['csdn'] || 'https://blog.csdn.net/qq_36005199'" target="_blank"><a-icon type="twitter" /></a>
        <!-- linkedin -->
